<?php
	...
	if($usertype=='instructor')
		$query="UPDATE instructor SET address = '$address', email = '$email' WHERE id = $userid ";
    else
		$query="UPDATE instructor SET password = '".$_POST['password']."', name = '$name', sex = '$sex', dept = '".$_POST['major']."', year = '$year', title = '$title', address = '$address', email = '$email' WHERE id = $id ";
