      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            ...
            <li  class="active"><a href="guidanceinfo.php">指导信息</a></li>
          </ul>
          <ul class="nav nav-sidebar">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">查看指导信息</h1>
		  <p>&nbsp;</p>
          <h2 class="sub-header">选择要查看的论文</h2>
              ...
              <tbody>
				<?php 
					if(is_array($_GET)&&count($_GET)==1){
						...
						while(isset($result[$i])){
							echo "<tr><td>".$paperid."</td>";
							echo "<td><a href=\"guidanceinfo.php?paperid=".$paperid."&fileid=".$result[$i]['fileid']."\">".$result[$i]['title']."</a></td>";
							echo "<td>".$result[$i]['author1']."\t".$result[$i]['author2']."\t".$result[$i]['author3']."\t".$result[$i]['author4']."\t".$result[$i]['author5']."\t".$result[$i]['author6']."</td>";
