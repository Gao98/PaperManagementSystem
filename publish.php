      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
			...
			<li class="active"><a href="publish.php">发表登记</a></li>
          </ul>
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">登记论文发表情况</h1>
		  <h2 class="sub-header"><br/>选择要登记的论文</h2>
              ...
              <tbody>
				<?php 
					if(is_array($_GET)&&count($_GET)==0){
						$result=$db->select("SELECT id, title, author1, author2, author3, author4, author5, author6, state, remark FROM paper_author NATURAL JOIN paper WHERE author1_id =$userid  and state!='未上传'");
						$i=0;
						while(isset($result[$i])){
							echo "<tr><td>".$result[$i]['id']."</td>";
							echo "<td><a href=\"publish.php?paperid=".$result[$i]['id']."\">".$result[$i]['title']."</a></td>";
		  ...
		  <div class="table-responsive">
            <form action="register.php?paperid=<?php echo $paperid;?>" method="post" enctype="multipart/form-data">
			<h3>发表刊物名</h3><input type="text" name="publication" class="form-control"/> 
			<h3>证明材料</h3><input type="file" name="file" id="file" style="width:100%;height:34px;" /> 
			<br />
